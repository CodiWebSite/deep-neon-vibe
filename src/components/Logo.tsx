  ...
  return (
    <div className="text-center">
      ...
      <div className="mt-3 flex items-center justify-center gap-2">
        <div className="h-px w-12 bg-gradient-to-r from-transparent via-party-gold to-transparent" />
        <p className="text-xs md:text-sm text-muted-foreground uppercase tracking-[0.3em]">
          🎉 Party & Manele Mix 🎉
        </p>
        <div className="h-px w-12 bg-gradient-to-r from-transparent via-party-pink to-transparent" />
      </div>
    </div>
  );
};
